...
function EspObject:Update()
	...
	self.options = interface.teamSettings[interface.isFriendly(self.player) and "friendly" or "enemy" or "instances"];
...
function InstanceObject:Render()
	...
	local options = interface.teamSettings["instances"];
	...
	if options.enabled then
		...
		text.Visible = options.textEnabled;
